...
function FocusScreen() {
  ...
  return (
    <Screen>
      ...
      <div
        className={cn(
          "mb-3 flex items-center gap-4 rounded-3xl glass p-5 transition-shadow",
      ...
      {native ? (
        bothGranted ? (
          <div className="mb-3 flex items-center gap-3 rounded-3xl glass px-5 py-4" style={{ animation: "cascadeIn 0.5s ease-out 0.2s both" }}>
          ...
          <div className="mb-3 flex flex-col gap-4 rounded-3xl glass px-5 py-4" style={{ animation: "cascadeIn 0.5s ease-out 0.2s both" }}>
        ...
        <div className="mb-3 flex items-start gap-3 rounded-3xl glass px-5 py-4" style={{ animation: "cascadeIn 0.5s ease-out 0.2s both" }}>
          <TriangleAlert className="mt-0.5 h-4 w-4 shrink-0 text-warning" />
          <p className="text-xs leading-relaxed text-muted-foreground">
